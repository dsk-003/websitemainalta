 ...
 */
Class Corporate_Blue_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Corporate_Blue_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Corporate_Blue_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="corporate-blue-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Corporate_Blue_Customize_Section_Upsell extends WP_Customize_Section {
