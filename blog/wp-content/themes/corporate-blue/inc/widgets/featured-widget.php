...
if ( ! class_exists( 'Corporate_Blue_Featured_Widget' ) ) :

     
    class Corporate_Blue_Featured_Widget extends WP_Widget {
        /**
        ...
        public function __construct() {
            ...
            parent::__construct( 'corporate_blue_featured_widget', esc_html__( 'ST: Featured Widget', 'corporate-blue' ), $st_widget_featured );
        }
                                        ...
                                        <div class="post-wrapper">
                                            ...
                                            <div class="entry-container">
                                                ...
                                                <div class="entry-content">
                                                    <?php echo esc_html( corporate_blue_trim_content( 20 ) ); ?>
                                                </div><!-- .entry-content -->
        ...
        public function form( $instance ) {
            $title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Featured', 'corporate-blue' );
            $read_more  = isset( $instance['read_more'] ) ? $instance['read_more'] : esc_html__( 'Read More', 'corporate-blue' );
