...
class Corporate_Blue_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corporate_blue';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corporate-blue' ), $i ),
...
// Initialize.
$corporate_blue_footer_widgets = new Corporate_Blue_Footer_Widgets();
